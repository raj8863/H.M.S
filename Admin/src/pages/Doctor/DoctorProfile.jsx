        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div className='flex gap-2 py-2'>
            ...
            <div className='text-sm'>
              {isEdit ? <input type="text" onChange={(e)=>setProfileData(prev => ({...prev, address: {...prev.address, line1: e.target.value}}))} value={profileData.address.line1} /> : <p>{profileData.address.line1}</p>}
              {isEdit ? <input type="text" onChange={(e)=>setProfileData(prev => ({...prev, address: {...prev.address, line2: e.target.value}}))} value={profileData.address.line2} /> : <p>{profileData.address.line2}</p>}
            </div>
          </div>
